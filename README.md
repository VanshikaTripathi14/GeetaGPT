...
A *production-grade mobile application* that combines ancient wisdom with modern AI technology. Users get personalized spiritual guidance through Bhagavad Gita teachings, powered by GROQ AI (Llama 3.3 70B).
...
- *Smart Authentication* - Firebase Email/Password with email verification + JWT security
- *AI-Powered Chat* - GROQ API (Llama 3.3 70B) integration for intelligent responses  
...
| Feature | Performance |
|---------|-------------|
| Email Verification | Instant via Firebase |
...
- *Secure Authentication* with Firebase email verification & JWT validation
...
- *Account Deletion* synchronized across Firebase & MongoDB
...
- *AI Integration* - Custom GROQ API implementation with Llama 3.3 70B
